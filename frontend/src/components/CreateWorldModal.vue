...
function backgroundFromLegacyResponse(themePreset?: string) {
  const legacyMap: Record<string, string> = {
    academy: '/themes/academy.jpg',
    library: '/themes/library.jpg',
    laboratory: '/themes/lab.jpg',
    lab: '/themes/lab.jpg',
    mountain: '/themes/mountain.jpg',
    mountain_academy: '/themes/mountain.jpg',
    cyber: '/themes/cyber.jpg',
    cyberspace: '/themes/cyber.jpg',
  }
  return themePreset ? (legacyMap[themePreset] || '') : ''
}
...
async function handleAiGenerate() {
  ...
  try {
    ...
    aiState.generatedBackgroundPicture =
      ...
      || backgroundFromLegacyResponse(result.theme_preset)
