...
import type { RelationshipStage, Expression, MilestoneEventType } from '@/shared/types'

// ==================== 页面背景图片 ====================
// 集中管理所有页面背景，Views 统一从此处引用
import loginBg from '@/shared/assets/login-bg.jpg'
import homeBg from '@/shared/assets/home-bg.png'
import charBg from '@/shared/assets/char-bg.jpg'
