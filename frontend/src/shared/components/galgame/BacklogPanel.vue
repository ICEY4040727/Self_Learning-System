        ...
        <div class="backlog-list galgame-scrollbar" ref="listRef">
          ...
          >
            <span class="backlog-sender">
              {{ msg.sender_type === 'user' ? '我' : teacherName }}
            </span>
...
interface Message {
  id: number
  sender_type: 'user' | 'teacher' | 'assistant' | 'system'
  content: string
}
...
.backlog-entry.assistant,
.backlog-entry.system {
...
.backlog-entry.assistant .backlog-sender,
.backlog-entry.system .backlog-sender {
  color: var(--accent-gold);
}
