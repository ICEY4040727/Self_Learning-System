...
// ---- Course Content (new: materials + learning units) ----

export type ExtractionStatus = 'pending' | 'processing' | 'ready' | 'error'
export type UnitStatus       = 'draft' | 'ready' | 'archived'
export type BloomLevelKey    = 'remember' | 'understand' | 'apply' | 'analyze' | 'evaluate' | 'create'
...
export interface LearningUnit {
  ...
  bloom_level:            BloomLevelKey | null
...
export const BLOOM_LABELS: Record<BloomLevelKey, string> = {
  remember:   '记忆',
  understand: '理解',
  apply:      '应用',
  analyze:    '分析',
...
export const BLOOM_COLORS: Record<BloomLevelKey, string> = {
  remember:   '#94a3b8',
  understand: '#60a5fa',
  apply:      '#4adf6a',
  analyze:    '#ffd700',
...
export const MAX_MATERIAL_SIZE_BYTES = 10 * 1024 * 1024  // 10 MB
