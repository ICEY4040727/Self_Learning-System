...
class TestComputeScaffoldLevel:
    ...
    def test_frustration_high_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("frustration", 60) == 4
    ...
    def test_confusion_high_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("confusion", 60) == 3

    def test_anxiety_low_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("anxiety", 40) == 4

    def test_anxiety_high_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("anxiety", 70) == 3

    def test_curiosity_high_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("curiosity", 70) == 2

    def test_curiosity_low_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("curiosity", 40) == 3

    def test_excitement_high_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("excitement", 80) == 1

    def test_excitement_low_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("excitement", 50) == 2

    def test_satisfaction_high_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("satisfaction", 80) == 1

    def test_satisfaction_low_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("satisfaction", 50) == 2

    def test_boredom_high_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("boredom", 70) == 2

    def test_boredom_low_mastery(self):
        assert ScaffoldContext.compute_scaffold_level("boredom", 40) == 3
    ...
    def test_unknown_emotion(self):
        assert ScaffoldContext.compute_scaffold_level("unknown", 50) == 3
